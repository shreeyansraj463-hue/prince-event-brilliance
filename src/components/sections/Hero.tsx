      ...
      <div className="relative z-10 container mx-auto px-4 pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary">Serving Saharsa & Nearby Districts</span>
          </motion.div>
          ...
          >
            <span className="text-foreground">Transform Your Events Into</span>
            <br />
            <span className="animate-shimmer">Unforgettable Memories</span>
          </motion.h1>
          ...
          >
            Complete Catering and Event Management Solutions. From intimate gatherings 
            to grand celebrations, we bring your vision to life with premium service and attention to detail.
          </motion.p>
